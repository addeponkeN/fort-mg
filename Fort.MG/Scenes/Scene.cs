...
public partial class Scene
{
	...
	private CanvasSystem _canvasSystem;
	...
	public Canvas Canvas => _canvasSystem.Canvas;
	...
	public virtual void Init()
	{
		...
		_canvasSystem = SystemManager.Register<CanvasSystem>();

		Cam = Entity.Create<Camera>();
		EntityManager.Add(Cam.Entity);
	...
	public virtual void Draw()
	{
		...
		{
			sb.Begin();
			sb.Draw(Engine.AssetManager.Pixel, new Rectangle(0, 0, Cam.Viewport.Width, Cam.Viewport.Height),
